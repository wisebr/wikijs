<template lang='pug'>
  v-container.admin-contribute(fluid, grid-list-lg)
    v-layout(row, wrap)
      v-flex(xs12)
        .admin-header
          img.animated.fadeInUp(src='/docs/_assets/svg/icon-heart-health.svg', alt='Contribute', style='width: 80px;')
          .admin-header-title
        ...
        v-card.mt-3.animated.fadeInUp
          v-card-text
            ...
            v-tabs.mx-3.radius-7.admin-contribute-tabs(
              ...
              v-tab
                span Patreon
                img.my-1(src='/docs/_assets/svg/icon-patreon.svg', style='height: 24px;')
              v-tab
                span OpenCollective
                img.my-1(src='/docs/_assets/svg/icon-opencollective.svg', style='height: 24px;')
              v-tab
                span PayPal
                img.my-1(src='/docs/_assets/svg/icon-paypal.svg', style='height: 24px;')
              v-tab
                span Ethereum
                img.my-1(src='/docs/_assets/svg/icon-ethereum.svg', style='height: 24px;')
              v-tab
                span T-Shirts
                img.my-1(src='/docs/_assets/svg/icon-t-shirt.svg', style='height: 24px;')
              v-tab-item(:transition='false', :reverse-transition='false')
                ...
                a.ml-3(href='https://github.com/users/NGPixel/sponsorship', :title='$t(`admin:contribute.becomeASponsor`)')
                  img(src='/docs/_assets/img/donate_github.svg', :alt='$t(`admin:contribute.becomeASponsor`)' style='width:200px;')
              v-tab-item(:transition='false', :reverse-transition='false')
                ...
                a.ml-3(href='https://www.patreon.com/bePatron?u=16744039', :title='$t(`admin:contribute.becomeAPatron`)')
                  img(src='/docs/_assets/img/donate_patreon.png', :alt='$t(`admin:contribute.becomeAPatron`)' style='width:200px;')
              v-tab-item(:transition='false', :reverse-transition='false')
                ...
                a.ml-3(href='https://opencollective.com/wikijs/donate', :title='$t(`admin:contribute.makeADonation`)')
                  img(src='/docs/_assets/img/donate_opencollective.png', :alt='$t(`admin:contribute.makeADonation`)' style='width:300px;')
              v-tab-item(:transition='false', :reverse-transition='false')
                ...
                .ml-3
                  form(action='https://www.paypal.com/cgi-bin/webscr', method='post', target='_top')
                    ...
                    input(type='image', src='/docs/_assets/img/donate_paypal.png', border='0', name='submit', title='PayPal - The safer, easier way to pay online!', alt='Donate with PayPal button')
              ...
              v-tab-item(:transition='false', :reverse-transition='false')
                ...
                .ml-3
                  ...
                  div: img(src='/docs/_assets/img/donate_eth_qr.png')
              v-tab-item(:transition='false', :reverse-transition='false')
          ...
          v-list(two-line)
            ...
            v-list-item
              v-list-item-avatar(tile)
                img(src='/docs/_assets/svg/logo-icons8.svg', alt='Icons8')
              v-list-item-content
