<template lang='pug'>
  v-container(fluid, grid-list-lg)
    v-layout(row, wrap, v-if='page.id')
      v-flex(xs12)
        .admin-header
          img.animated.fadeInUp(src='/docs/_assets/svg/icon-view-details.svg', alt='Edit Page', style='width: 80px;')
          .admin-header-title
          ...
          v-menu(offset-y, origin='top right')
            ...
            v-list(dense, nav)
              v-list-item(:href='`/docs/` + page.locale + `/` + page.path')
                v-list-item-icon
                  v-icon(color='indigo') mdi-text-subject
                v-list-item-title View
              v-list-item(:href='`/docs/e/` + page.locale + `/` + page.path')
                v-list-item-icon
              ...
              v-list-item(:href='`/docs/s/` + page.locale + `/` + page.path')
                v-list-item-icon
                  v-icon(color='indigo') mdi-code-tags
                v-list-item-title View Source
              v-list-item(:href='`/docs/h/` + page.locale + `/` + page.path')
                v-list-item-icon
