            ...
            v-flex(xs6)
              v-card.radius-7.animated.fadeInUp.wait-p1s(
                ...
                v-card-text.text-center(@click='selectEditor("markdown")')
                  img(src='/docs/_assets/svg/editor-icon-markdown.svg', alt='Markdown', style='width: 36px;')
            ...
            v-flex(xs6)
              v-card.radius-7.animated.fadeInUp.wait-p2s(
                ...
                v-card-text.text-center(@click='selectEditor("ckeditor")')
                  img(src='/docs/_assets/svg/editor-icon-ckeditor.svg', alt='Visual Editor', style='width: 36px;')
            ...
            v-flex(xs4)
              v-card.radius-7.animated.fadeInUp.wait-p3s(
                ...
                v-card-text.text-center(@click='selectEditor("asciidoc")')
                  img(src='/docs/_assets/svg/editor-icon-asciidoc.svg', alt='AsciiDoc', style='width: 36px;')
            ...
            v-flex(xs4)
              v-card.radius-7.animated.fadeInUp.wait-p4s(
                ...
                v-card-text.text-center(@click='selectEditor("code")')
                  img(src='/docs/_assets/svg/editor-icon-code.svg', alt='Code', style='width: 36px;')
            ...
            v-flex(xs4)
              v-card.radius-7.animated.fadeInUp.wait-p5s(
                ...
                v-card-text.text-center(@click='fromTemplate')
                  img(src='/docs/_assets/svg/icon-cube.svg', alt='From Template', style='width: 42px; opacity: .5;')
...
export default {
  ...
  methods: {
    ...
    fromTemplateHandle ({ id }) {
      ...
      this.isShown = false
      this.$nextTick(() => {
        window.location.assign(`/docs/e/${this.locale}/${this.path}?from=${id}`)
      })
    }
  }
}
